...
$.ajax({
type:"post",
url:"<?php echo base_url('Dashboard/update_user_profile')?>",
...
window.location.href='<?php echo base_url('Dashboard/profil') ?>';    
});   
...
processData: false,
contentType: false,
url:"<?php echo base_url('Dashboard/simpan_profile'); ?>",
data:formData,
success:function(data){
