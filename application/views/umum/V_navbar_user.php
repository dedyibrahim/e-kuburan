...
<div class="col-md-4 "><a href="<?php echo base_url('User/') ?>">
...
<div class="col-md-4  "><a href="<?php echo base_url('User/halaman_proses') ?>">
<div class="bg_data rounded-top">
<div class="p-2">
...
<div class="col-md-4 "><a href="<?php echo base_url('User/halaman_selesai') ?>">
<div class="bg_data rounded-top">
<div class="p-2">
