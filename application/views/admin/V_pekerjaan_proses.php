...
<div class="col card p-2">
    <a href="<?php echo base_url('Admin/proses_berkas/'. base64_encode($data['no_berkas'])) ?>"><button class="btn btn-success btn-block">Kerjakan  Tugas <span class="fa fa-pencil-alt"> </span></button></a>   
<hr>
<p>Tanggal dibuat pekerjaan : <?php echo $data['tanggal_dibuat'] ?><br>
Tanggal diproses : <?php echo $data['tanggal_proses'] ?></p>
