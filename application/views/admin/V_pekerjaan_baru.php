...
<div class="row p-1">
<div class="col-md-8  "><h5 align="center">Data client yang ingin di kerjakan</h5><hr>
...
<button onclick="tambahkan_kedalam_antrian('<?php echo $data['no_berkas'] ?>');" class="btn btn-success btn-block">Tambahkan kedalam antrian  <span class="fa fa-plus"> </span></button>   
<hr>
Tanggal dibuat pekerjaan : <?php echo $data['tanggal_dibuat'] ?></p><br>
