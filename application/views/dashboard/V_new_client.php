...
<div style="display:none;" class="container" id="form_perorangan">
<h1>PERORANGAN</h1>

</div>
<div style="display:none;" class="container" id="form_badan_hukum">
<hr>
<form  id="fileForm" method="post" action="<?php echo base_url('Dashboard/create_client') ?>">
<div class="row">
   
<div class="col-md-4">
<h5 align="center">Data Badan Hukum</h5><hr>
...
<button type="submit" class="btn btn-success btn-block simpan_perizinan">Simpan & Proses Perizinan <i class="fa fa-save"></i></button>
</form>
</div>    
...
$("#form_perorangan").show(100);   
$("#form_badan_hukum").hide(100);    
}else{
$("#form_badan_hukum").show(100);       
$("#form_perorangan").hide(100);   
}
...
<div class='col'>\n\
<label>Nama KTP</label>\n\
<input type='text' id='ktp"+h+"' value='' class='form-control' placeholder='Nama . . .'></div>\n\
<div class='col'>\n\
<label>NIK KTP</label>\n\
<input type='text' id='nik"+h+"' value='' class='form-control' placeholder='NIK . . .'>\n\
</div>\n\
<div class='col' >\n\
<label>Status</label>\n\
<select id='status"+h+"' class='form-control'>\n\
<option>Direksi</option>\n\
<option>Komisaris</option>\n\
</select></div>\n\
</div> ";
