...
$.ajax({
type:"post",
url:"<?php echo base_url('User3/update_user')?>",
...
window.location.href='<?php echo base_url('User3/profil') ?>';    
});   
...
$.ajax({
type:"post",
url:"<?php echo base_url('User3/update_password')?>",
...
processData: false,
contentType: false,
url:"<?php echo base_url('User3/simpan_profile'); ?>",
data:formData,
success:function(data){
